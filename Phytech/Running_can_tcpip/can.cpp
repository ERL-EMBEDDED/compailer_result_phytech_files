...
void CanInterface::ReceivedData() {
   {
    ...
    int speed = (receivedValue / 65535.0) * 500;
    *actualVehicleSpeed = speed *speed_scale;
...
void CanInterface::sendData() {
    ...
    int speed = *expectedVehicleSpeed /speed_scale;
    uint16_t scaledValue = static_cast<uint16_t>(( speed / 500.0) * 65535);
